...
CREATE TABLE IF NOT EXISTS films (
    ...
    release_date date,
    duration integer,
    mpa_id INTEGER REFERENCES mpas ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS friendship (
    following_user_id INTEGER REFERENCES users ON DELETE CASCADE,
    followed_user_id INTEGER REFERENCES users ON DELETE CASCADE,
    status varchar,
